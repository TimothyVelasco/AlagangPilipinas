...
@section('content')
    ...
    <div class="container">
        ...
        <a type="button" href="" style="float:right"  class="btn btn-success mt-2 mb-3">Download as Excel</a>
        <div class="content">
            <table class="table table-striped" id="sales">
                ...
                <tr>
                    ...
                    <td>{{ $user->city }}</td>
                    <td>{{ $user->email }}</td>
                    <td><a  href="{{ route('userlistdetails.userdetails', ['id' => $user->id]) }}" class="btn btn-primary">View Profile<a></td>
                    @endforeach
            </table>
        </div>
