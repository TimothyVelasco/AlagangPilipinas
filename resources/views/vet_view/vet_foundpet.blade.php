            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="blog" action="{{ route('vetfoundpetupload.foundpetupload') }}" method="post"
                ...
                <div class="col-sm-6 mb-2 mt-3">
                    <div class="card text-bg-secondary">
                        <div class="card-body">
                            ...
                            <a href="{{route('vetfoundpetdetails.foundpet',['id'=>$found_pet->id])}}" class="btn btn-primary" style="float: right;">Read more</a>
                        </div>
                    </div>
                </div>
            @endforeach
                ...
                <div class="col-sm-6 mb-2 mt-3">
                    <div class="card text-bg-secondary">
                        <div class="card-body">
                            ...
                            <a href="{{route('vetfoundpetdetails.foundpet',['id'=>$allfound_pet->id])}}" class="btn btn-primary" style="float: right;">Read more</a>
                        </div>
                    </div>
                </div>
            @endforeach
