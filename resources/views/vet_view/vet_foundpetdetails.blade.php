            ...
            <div class="row g-0">
              <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                  <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                    <a class="btn btn-primary mb-5" href="{{route('vetfoundpet.foundpet')}}">Back to Found Pets</a>
                    <center>
                      <h1>PET FOUND!</h1>
                      <br>
                      <img src="/storage/foundpet_photos/{{$found_pet_details->pet_photo}}" width="100%" style="border: 5px solid #FFFFFF">
                    </center>
                  </div>
                </div>
              <div class="col-md-6">
                <div class="card-body p-md-5 mx-md-6">
                  ...
                  <p>{{$found_pet_details->description}}</p>
  
                  <h5 class="mt-4 mb-1 pb-1" style="color: #C04000">Located:</h5>
                  <p>{{$found_pet_details->location}}</p>
  
                  <h5 class="mt-4 mb-1 pb-1" style="color: #C04000">Color:</h5>
                  <p>{{$found_pet_details->color}}</p>
                  
                  <h5 class="mt-4 mb-1 pb-1" style="color: #C04000">Breed:</h5>
                  <p>{{$found_pet_details->breed}}</p>
  
                  <h5 class="mt-4 mb-1 pb-1" style="color: #C04000">Gender:</h5>
                  <p>{{$found_pet_details->gender}}</p>
  
                  <center><h2 class="mt-4 mb-1 pb-1" style="color: #C04000">Contact:</h2>
                  <p>{{$found_pet_details->contact}}</p>
                  </center>
