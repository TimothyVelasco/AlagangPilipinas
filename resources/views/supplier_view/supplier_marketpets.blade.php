...
@section('content')
    ...
    <div class="container">
        ...
        <form class="example mb-5" method="post" action="{{route('supplierMarketSearch.suppliesMarketPetsSearch')}}">
            @csrf
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                        <div class="col-12 card mb-5">
                            ...
                            <div class="card-body">
                                ...
                                <a href="{{ route('suppliermarketpdetails.suppliermarketpdetails', ['id' => $product_sell->id]) }}"
