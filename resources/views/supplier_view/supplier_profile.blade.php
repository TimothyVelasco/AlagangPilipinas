                    ...
                    <div class="card" id="pbg">
                        <div class="card-body">
                            ...
                            <div class="align-items-center text-center mt-3">
                                ...
                                <img src="/storage/supplier_profile_photos/{{$user->supplierprofilephoto}}" id="dp" alt=".." class="rounded-circle" width="130">
                                @endforeach
                                <div class="mt-3">
                                    <h4>{{$user->firstname}} {{$user->lastname}}</h4>
                                    <p style="color:rgb(0, 0, 0)">Seller</p>
                                    <p style="color:rgb(0, 0, 0)">{{$user->gender}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
