    ...
    <div class="container">
        <div>
            <div class="sidenav">
                ...
                <a href="{{ route('supplier.sales') }}">Sales</a>
                <center>
                    <h1>Marketplace</h1>
                </center>
                <a href="{{ route('suppliermarketplace.marketplace') }}">Latest</a>
                <a href="{{ route('suppliermarketvets.marketvets') }}">Vets</a>
                <a href="{{ route('suppliermarketsupplies.marketsupplies') }}">Supplies</a>
                <a href="{{ route('suppliermarketpets.marketpets') }}">Pets</a>
            </div>
        </div>
        <center>
            <h1 style="margin-top: 20px; margin-bottom:20px;">Marketplace test</h1>
        </center>
        <form class="example mb-5" method="post" action="{{route('supplierMarketSearch.supplierMarketSearch')}}">
            @csrf
            <input type="text" placeholder="Search a Product" name="search">
            <button type="submit"><i class="fa fa-search"></i>Search</button>
        </form>

        <center><a id="compare-link" href="{{route('supplierproductcompare.productcompare')}}" class="btn btn-success mb-4" style="">Compare Products</a></center>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                        ...
                        <div class="col-12 card mb-5">
                            ...
                            <div class="card-body">
                                ...
                                <a href="{{ route('suppliermarketpdetails.suppliermarketpdetails', ['id' => $product_sell->id]) }}" class="btn btn-primary">View
                                    Details</a>
                            </div>
                            <center>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('.product-sell-checkbox').change(function() {
                ...
                let current_link = '{{route('supplierproductcompare.productcompare')}}';
