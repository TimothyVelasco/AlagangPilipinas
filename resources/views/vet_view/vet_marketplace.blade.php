...
@section('content')
    ...
    <div class="container">
        ...
        <form class="example mb-5" method="post" action="{{ route('vetmarketplace.vetMarketSearch') }}">
            @csrf
            <input type="text" placeholder="Search a Product" name="search">
            <button type="submit"><i class="fa fa-search"></i>Search</button>
        </form>

        <center><a id="compare-link" href="{{ route('vetproductcompare.productcompare') }}" class="btn btn-success mb-4"
                style="">Compare Product</a></center>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                        ...
                        <div class="col-12 card mb-5">
                            ...
                            <div class="card-body">
                                ...
                                <a href="{{ route('marketpdetails.vetmarketpdetails', ['id' => $product_sell->id]) }}"
