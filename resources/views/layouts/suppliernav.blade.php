        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="{{ route('supplierhomepage.homepage') }}">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('suppliermarketplace.marketplace') }}">Marketplace</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('supplierlostpet.supplierlostpet') }}">Lost Pets</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" href="{{ route('foundpet.supplierfoundpet') }}">Found Pets</a></li>
                        </ul>
                    </li>
                </ul>
                <ul class="navbar-nav">
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-lg-start">
                            <li><a class="dropdown-item" href="{{ route('supplier_profile.profile') }}">Profile</a></li>
