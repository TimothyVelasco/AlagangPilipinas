@extends('layouts.vet_petlostlayout')
@section('content')
    @push('css')
    @endpush
    ...
    <div class="container">
        <div class="">
            ...
            <div class="p-4 p-md-5 mb-4 rounded text-bg-dark"
                ...
                <div class="col-md-6 px-0">
                    ...
                    <p class="lead my-3">Post your missing pet here </p>
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="blog" action="{{ route('lostpetupload.supplierlostpetupload') }}" method="post"
                ...
                <div class="col-sm-6 mb-2 mt-3">
                    <div class="card text-bg-secondary">
                        <div class="card-body">
                            ...
                            <a href="{{route('vetlostpetdetails.lostpet',['id'=>$lost_pet->id])}}" class="btn btn-primary" style="float: right;">Read more</a>
                        </div>
                    </div>
                </div>
            @endforeach
        ...
        <center>
            <h4 style="color:white">Upload a Missing Pet</h4>
        </Center>
        <div class="row">
            @foreach ($all_lost_pets as $all_lost_pets)
                <div class="col-sm-6 mb-2 mt-3">
                    <div class="card text-bg-secondary">
                        <div class="card-body">
                            <h5 class="card-title">{{  $all_lost_pets->location }}</h5>
                            <p class="card-text"> {{  $all_lost_pets->description }}</p>
                            <a href="{{route('vetlostpetdetails.lostpet',['id'=>$all_lost_pets->id])}}" class="btn btn-primary" style="float: right;">Read more</a>
                        </div>
                    </div>
                </div>
            @endforeach
