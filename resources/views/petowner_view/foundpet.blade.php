...
@section('content')
    ...
    <div class="container">
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="blog" action="{{ route('foundpetupload.foundpetupload') }}" method="post"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="color"class="form-control" id="recipient-name">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="col mb-4 "> Gender
                                ...
                                <div class="mb-2">
                                    ...
                                    <input class="form-control" name="pet_photo" type="file" id="formFileMultiple" required
                                        multiple>
                ...
                <div class="col-sm-6 mb-2 mt-3">
                    <div class="card text-bg-secondary">
                        <div class="card-body">
                            ...
                            <a href="{{route('foundpetdetails.foundpet',['id'=>$found_pet->id])}}" class="btn btn-primary" style="float: right;">Read more</a>
                        </div>
                    </div>
                </div>
            @endforeach
        ...
        <center>
            <h4 style="color:white" class="mt-3">All Found Pet</h4>
        </Center>
        <div class="row">
                ...
                <div class="col-sm-6 mb-2 mt-3">
                    <div class="card text-bg-secondary">
                        <div class="card-body">
                            ...
                            <a href="{{route('foundpetdetails.foundpet',['id'=>$allfound_pet->id])}}" class="btn btn-primary" style="float: right;">Read more</a>
                        </div>
                    </div>
                </div>
            @endforeach
