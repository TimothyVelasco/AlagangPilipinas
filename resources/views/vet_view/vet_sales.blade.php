        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body ">
                    <form id="vets" action="{{ route('vetproductsell.vetsell') }}" method="post" enctype="multipart/form-data">
                        @csrf
        ...
        <table class="table table-striped" id="sales">
            ...
            @foreach ($product_sells as $product_sell)
                <tr>
                    ...
                    <td><a
                            href="{{ route('vetsproductdetails.sproductdetails', ['id' => $product_sell->id]) }}">{{ $product_sell->product_name }}</a>
                    </td>
