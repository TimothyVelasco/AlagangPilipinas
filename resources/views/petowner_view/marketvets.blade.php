...
@section('content')
    ...
    <div class="container">
        ...
        <form class="example mb-5" method="post" action="{{route('marketvets.marketVetSearch')}}">
            @csrf
            <input type="text" placeholder="Search a Product" name="search">
            <button type="submit"><i class="fa fa-search"></i>Search</button>
        </form>

        <center><a id="compare-link" href="{{route('vetcompare.vetcompare')}}" class="btn btn-success mb-4" style="">Compare Vet Clinic</a></center>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                        <div class="col-12 card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="{{ route('marketpdetails.marketvetpdetails', ['id' => $vet->id]) }}" class="btn btn-primary">View Details</a>
                            </div>
                            <center>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('.vet-id-checkbox').change(function() {
                ...
                let current_link = '{{route('vetcompare.vetcompare')}}';
