...
@section('content')
    ...
    <div class="container">
        ...
        <form class="example mb-5" method="post" action="{{route('supplierMarketSearch.suppliesMarketSuppliesSearch')}}">
            @csrf
    ...
    <script>
        ...
        $(document).ready(function() {
            $('.product-sell-checkbox').change(function() {
                ...
                let current_link = '{{route('vetproductcompare.productcompare')}}';
