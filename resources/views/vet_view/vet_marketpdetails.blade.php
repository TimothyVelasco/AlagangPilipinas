    ...
    <div class="p-0 information container"
        ...
        <div class="row" style="margin:20px; background-color: white;">
            <div class="col-3 p-3 border-bottom" style="background-color:#54718D;">
                <a class="btn btn-primary mb-3" href="{{route('vetmarketplace.marketplace')}}">back to Marketplace</a>
            ...
            <div class="col-6 p-3 border-bottom" style="background-color:#54718D;">
                <a href="{{ route('vetsellerdetails.sellerdetails', ['id' => $product_sell->id]) }}" class="btn  m-3"style="float: right; background-color:#83C44A">Seller Contact Details</a>
            </div>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-9 p-3" style="background-color:white">
                            <form method="post" action="{{route('vetpreview.vetmarketpdetails')}}" >
                                @csrf
                        ...
                        <div class="col-9 p-3" style="background-color:white">
                            <button type="submit" href="#" class="btn btn-primary "style="float: right;">Upload Review</button>
                        </div>
                    </form>
                    </div>
                </div>
