        ...
        <div>
            <div class="row" style="margin:20px; background-color: white;">
                <div class="col-3 p-3 border-bottom" style="background-color:#54718D;">
                    <a href="{{ route('sales.sales', ) }}" class="btn btn-primary mb-3">Back to sales</a>
                ...
                <div class="col-6 p-3 border-bottom" style="background-color:#54718D;">
                    <a href="{{ route('sproductdetails.markAsSold', ['productSellId' => $product_sell->id]) }}" class="btn  m-3"style="float: right; background-color:#83C44A">MARK AS SOLD</a>
                </div>
