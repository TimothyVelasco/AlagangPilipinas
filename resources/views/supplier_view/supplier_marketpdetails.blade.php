    ...
    <div class="p-0 information container"
        ...
        <div class="row" style="margin:20px; background-color: white;">
            <div class="col-3 p-3 border-bottom" style="background-color:#54718D;">
                <a class="btn btn-primary mb-3" href="{{ route('suppliermarketplace.marketplace') }}">back to
                    Marketplace</a>
            ...
            <div class="col-6 p-3 border-bottom" style="background-color:#54718D;">
                <a href="{{ route('suppliersellerdetails.sellerdetails', ['id' => $product_sell->id]) }}"
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-9 p-3" style="background-color:white">
                            <form method="post"
                                action="{{ route('supplierreview.vetmarketpdetails', ['id' => $product_sell->id]) }}">
                                @csrf
                        ...
                        <div class="col-9 p-3" style="background-color:white">
                            <button href="{{ route('supplierreview.vetmarketpdetails') }}" type="submit"
                                class="btn btn-primary "style="float: right;">Upload Review</button>
                        </div>
                        </form>
                    </div>
                </div>
