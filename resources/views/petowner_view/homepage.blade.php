...
<div class="album py-5 bg-light">
  <div class="container">
    <center><h2 class="pb-2 border-bottom" id="market">MARKET</h2></center>
    <br>
      ...
      <div class="col">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text card-description">Some quick example text to build on the card title and make up the bulk of the card's content.Some quick example text to build on the card title and make up the bulk of the card's content.Some quick example text to build on the card title and make up the bulk of the card's content.Some quick example text to build on the card title and make up the bulk of the card's content.</p>
...
<section class="py-5 text-center">
  <div class="row py-lg-5">
    @foreach($users as $user)
      <h1 class="fw-light">WELCOME {{$user->firstname}} {{$user->lastname}}</h1>
      @endforeach
...
<div class="container px-4 py-5">
    ...
    <div class="row row-cols-1 row-cols-sm-2 g-4">
      <div class="d-flex flex-column gap-2">
        <div
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-shop" viewBox="0 0 17 17">
      ...
      <div class="d-flex flex-column gap-2">
        <div
          class="feature-icon-small d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-4 rounded-3">
          <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-file-text" viewBox="0 0 19 17">
            <path d="M5 4a.5.5 0 0 0 0 1h6a.5.5 0 0 0 0-1H5zm-.5 2.5A.5.5 0 0 1 5 6h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5zM5 8a.5.5 0 0 0 0 1h6a.5.5 0 0 0 0-1H5zm0 2a.5.5 0 0 0 0 1h3a.5.5 0 0 0 0-1H5z"/>
            <path d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2zm10-1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1z"/>
          </svg>
        </div>
        <h4 class="fw-semibold mb-0">User Blog Window</h4>
        <p class="text-muted">This feature is available for the user’s that would like to see, create and post a
      ...
      <div class="d-flex flex-column gap-2">
        <div
          class="feature-icon-small d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-4 rounded-3">
          <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-chat-square-dots" viewBox="0 0 20 15">
  ...
  <div class="row">
    <div class="col-lg-4">
      <img class="bd-placeholder-img rounded-circle" src="../image/Tims.jfif" width="140" height="140"/>
      <h2 class="fw-normal">Timothy Velasco</h2>
      <p>Project Manager / Lead Developer</p>
      
    </div><!-- /.col-lg-4 -->
    <div class="col-lg-4">
      <img class="bd-placeholder-img rounded-circle" src="../image/keith.jpg" width="140" height="140"/>
      <h2 class="fw-normal">Keith Topino</h2>
      <p>Main UI Designer</p>
      
    </div><!-- /.col-lg-4 -->
    <div class="col-lg-4">
      <img class="bd-placeholder-img rounded-circle" src="../image/Luwe.jpg" width="140" height="140"/>
      <h2 class="fw-normal">Louie Cortero</h2>
      <p>Support Programmer</p>
      
    </div><!-- /.col-lg-4 -->
    <div class="col-lg-4 mt-5">
      <img class="bd-placeholder-img rounded-circle" src="../image/jell.jpg" width="140" height="140"/>
    ...
    <br>
    <div class="col-lg-4 mt-5">
      <img class="bd-placeholder-img rounded-circle" src="../image/kaye.jpg" width="140" height="140"/>
      <h2 class="fw-normal">Kaye Urquiza</h2>
      <p>Secretary</p>
      
    </div><!-- /.col-lg-4 -->
    <div class="col-lg-4 mt-5">
      <img class="bd-placeholder-img rounded-circle" src="../image/josh.png" width="140" height="140"/>
