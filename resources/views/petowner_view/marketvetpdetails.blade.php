    ...
    <div class="p-0 information container"
        ...
        <div class="row" style="margin:20px; background-color: white;">
            <div class="col-3 p-3 border-bottom" style="background-color:#54718D;">
                <a class="btn btn-primary mb-3" href="{{route('marketvets.marketvets')}}">back to Marketplace</a>
            ...
            <div class="col-6 p-3 border-bottom" style="background-color:#54718D;">
                <a href="{{ route('vetdetails.sellerdetails', ['id' => $vet->id]) }}" class="btn  m-3"style="float: right; background-color:#83C44A">
                    Vet Clinic Profile Details</a>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-9 p-3" style="background-color:white">
                            <form method="post" action="{{route('marketpdetails.vetreview')}}" >
                                @csrf
